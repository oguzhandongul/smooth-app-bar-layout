 ...
 */
public class SmoothCollapsingToolbarLayoutOld extends LinearLayout {
  ...
  public SmoothCollapsingToolbarLayoutOld(Context context) {
    super(context);
    init(null);
  }

  public SmoothCollapsingToolbarLayoutOld(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(attrs);
  }

  @TargetApi(Build.VERSION_CODES.HONEYCOMB)
  public SmoothCollapsingToolbarLayoutOld(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(attrs);
  }

  @TargetApi(Build.VERSION_CODES.LOLLIPOP)
  public SmoothCollapsingToolbarLayoutOld(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    if (!isInEditMode()) {
      mOnAppBarLayoutOffsetChangedListener = new AppBarLayout.OnOffsetChangedListener() {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
          SmoothCollapsingToolbarLayoutOld.this.onOffsetChanged(appBarLayout, i);
        }
      };
  ...
  protected void updateViews(float ratio) {
    ...
    if (isTitleTextSizeEnabled()) {
      ViewCompat.setScaleX(vTitle, ratio);
      ViewCompat.setScaleY(vTitle, ratio);
      ViewCompat.setPivotX(vTitle, 0);
      ViewCompat.setPivotY(vTitle, vTitle.getMeasuredHeight());
